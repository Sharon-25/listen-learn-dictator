        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative animate-slide-in-up delay-300">
            <div className="relative rounded-2xl overflow-hidden shadow-float">
              <img 
                src={heroImage} 
                alt="Documents transforming into audio waves"
                className="w-full h-auto"
              />
              
              {/* Floating audio visualization */}
              <div className="absolute bottom-6 left-6 right-6 bg-white/10 backdrop-blur-md rounded-lg p-4">
                ...
                <div className="flex items-center gap-1 h-8">
                  {Array.from({ length: 40 }).map((_, i) => (
                    <div
                      key={i}
                      className={`bg-accent-mint rounded-full w-1 animate-wave ${
                        i % 4 === 0 ? 'animate-wave-delay-1' :
                        i % 4 === 1 ? 'animate-wave-delay-2' :
                        i % 4 === 2 ? 'animate-wave-delay-3' : ''
                      }`}
                      style={{
